...
// Query: *[_type == 'onboarding' && language == $language][0]{    _id,    _type,    title,    language,    description,    skipLabel,    backLabel,    footerText,    breadcrumbs,    slide1{      title,      body,      primaryCtaLabel,      secondaryCtaText,      returnToCtaText,      homePageButtonLabel    },    slide2{      title,      body,      nextButtonLabel,      nextButtonPrefix,      nextButtonSuffix,      backButtonPrefix,      backButtonSuffix,      selectPrefix,      selectSuffix,      audienceTypeLabel    },    slide3{      title,      body,      finishButtonLabel,      finishButtonPrefix,      finishButtonSuffix,      backButtonPrefix,      backButtonSuffix,      selectPrefix,      selectSuffix    }  }
...
export type PATTERN_UTILITIES_QUERYResult = {
  ...
  themeMiniBadgeLabel: string | null
} | null
