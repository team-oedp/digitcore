...
export const siteSettingsType = defineType({
  ...
  fields: [
    ...
    defineField({
      ...
      type: 'url',
      group: 'general',
      description: 'The main URL for your site (used for SEO and social sharing)',
    }),
    ...
    defineField({
      ...
      description: 'Fallback meta description for pages without specific SEO descriptions',
    }),
    defineField({
      name: 'seoImage',
