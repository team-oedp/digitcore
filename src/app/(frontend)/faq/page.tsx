...
export const metadata: Metadata = {
	...
	description: "Frequently asked questions about the DIGITCORE Toolkit for Collaborative Environmental Research.",
};
...
const PATTERNS_FAQS = [
	{
		...
		answer: "A pattern represents a recurring solution or approach to common challenges in collaborative environmental research. Patterns capture tested methods, frameworks, and strategies that have proven effective across different communities and contexts, serving as reusable templates for similar situations."
	},
	{
		id: "pattern-2",
		question: "How do patterns structure in this toolkit?",
		answer: "Patterns in our toolkit are structured with clear documentation of the problem they address, the solution they provide, the context in which they work best, and examples of successful implementation. This structure enables communities to easily adapt and apply patterns to their specific environmental research needs."
	},
	{
		id: "pattern-3",
		question: "Why the pattern as an organising method?",
		answer: "Patterns serve as an organizing method because they capture both practical solutions and the underlying principles that make them work. This approach enables knowledge transfer between communities while respecting local contexts and allowing for adaptation based on specific needs and circumstances."
	},
	{
		id: "pattern-4",
		question: "What defines a pattern and its operation?",
		answer: "A pattern is defined by its ability to solve a recurring problem in a specific context. Its operation involves clear documentation of implementation steps, expected outcomes, potential variations, and guidance for adaptation. Each pattern operates as both a practical tool and a learning resource for collaborative environmental research."
	},
	{
		id: "pattern-5",
		question: "What is the significance of patterns for users?",
		answer: "For users, patterns provide tested pathways to address environmental research challenges without starting from scratch. They offer confidence through proven approaches while maintaining flexibility for local adaptation, ultimately accelerating effective community-led environmental research and action."
	},
	{
		id: "pattern-6",
		question: "Data Governance",
		answer: "Data governance in our toolkit encompasses the policies, procedures, and principles that ensure community data sovereignty and ethical research practices. This includes frameworks for community consent, data ownership, access controls, and ensuring that data use aligns with community values and self-determination."
	}
] as const;
