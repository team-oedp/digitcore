import { CustomizableIconProps } from './customizable-icon';
 ...
 * Validate icon props
 */
export function validateIconProps(props: Partial<CustomizableIconProps>): boolean {
  // Check opacity values are between 0 and 1
  if (props.fillOpacity !== undefined && (props.fillOpacity < 0 || props.fillOpacity > 1)) {
    console.warn('fillOpacity should be between 0 and 1');
    return false;
  }
  
  if (props.strokeOpacity !== undefined && (props.strokeOpacity < 0 || props.strokeOpacity > 1)) {
