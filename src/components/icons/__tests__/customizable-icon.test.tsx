...
import { applyColorPreset, getIconPath, validateIconProps } from '../icon-utils';
...
describe('Icon Utilities', () => {
  describe('getIconPath', () => {
    ...
    it('throws error for invalid icon numbers', () => {
      expect(() => getIconPath(0)).toThrow('Icon number must be between 1 and 24');
      expect(() => getIconPath(25)).toThrow('Icon number must be between 1 and 24');
      expect(() => getIconPath(-1)).toThrow('Icon number must be between 1 and 24');
    });
  });
