...
describe('CustomizableIcon Integration Tests', () => {
  ...
  it('supports different color formats', () => {
    ...
    colorFormats.forEach(({ format, value }) => {
  ...
  it('memoizes style object to prevent unnecessary re-renders', () => {
    ...
    expect(icon2.style.getPropertyValue('--icon-stroke-color')).toBe('#constant');
    ...
    expect(icon3.style.getPropertyValue('--icon-stroke-color')).toBe('#constant');
  });
