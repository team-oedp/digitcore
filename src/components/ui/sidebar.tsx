	...
	return (
		...
		>
			...
			<div
				...
				className={cn(
					"relative w-(--sidebar-width) bg-transparent transition-[width] duration-600 ease-[cubic-bezier(0.22,1,0.36,1)]",
			...
			<div
				...
				className={cn(
					"fixed inset-y-0 z-10 hidden h-svh w-(--sidebar-width) transition-[left,right,width] duration-600 ease-[cubic-bezier(0.22,1,0.36,1)] md:flex",
					side === "left"
