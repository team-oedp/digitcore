const __vite__mapDeps = (
	...
	d = m.f ||
		(m.f = [
			"static/index-DvRG7byN.js",
			"static/sanity-K-MUZH2i.js",
			"static/index2-KE8uHyLL.js",
		]),
) => i.map((i) => d[i]);
import {
	ao as $e,
...
function Gt(t) {
	...
	return e
		? { intent: e, params: xe(t.params) ? t.params : Ht, payload: t.payload }
		: void 0;
}
const Ut = Re.span`
...
function Jt(t) {
	...
	let x;
	e[4] !== d
		? ((x = p.jsx(Ke, { as: "h2", children: d })), (e[4] = d), (e[5] = x))
		: (x = e[5]);
	let I;
	e[6] !== l || e[7] !== o
		? ((I =
	...
	e[27] !== w
		? ((_ = p.jsx(ne, {
				marginTop: 4,
				children: p.jsx(He, { text: w, icon: Fe, tone: "primary", onClick: c }),
			})),
			(e[27] = w),
			(e[28] = _))
		: (_ = e[28]);
...
const Zt = {
		component: S.lazy(() =>
			Z(() => import("./index-DvRG7byN.js"), __vite__mapDeps([0, 1])),
		),
		document: S.lazy(() =>
			Z(() => import("./sanity-K-MUZH2i.js").then((t) => t.bf), []).then(
				(t) => t.pane,
			),
		),
		documentList: S.lazy(() =>
		...
		list: S.lazy(() =>
			Z(() => import("./index2-KE8uHyLL.js"), __vite__mapDeps([2, 1])),
		),
	},
	en = S.memo(
		(t) => {
